(function() {
  ...
  App.Views.Output = Backbone.View.extend({
    ...
    create : function(collection) {
      ...
      var url_start = '&lt;script src="<span class="url">http://use.edgefonts.net/',
          url_end = ".js</span>\">&lt;/script>",
          content = "";

      url_start = '<span>// JavaScript to include the font</span>\n' + url_start;
      content = '<hr><span>/* CSS to set the font-family */</span>' + content;
      content += '\nh1 {\n';
